...
export const SortableTable: React.VFC<iTableProps<iFood>> = ({
  ...
  const [rows, setRows] = React.useState<iFood[]>(tableData);
...
export const TablePaginated: React.VFC<iTableProps<iFood>> = () => {
  ...
  return (
    <Col flex={1} fullHeight spacing={24} className="overflow-hidden">
      <Table
        tableHeadingCells={tableHeadingCells}
        data={paginatedData}
        renderTableItem={renderRow}
